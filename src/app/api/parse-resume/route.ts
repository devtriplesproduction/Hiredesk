...
export async function POST(req: NextRequest) {
  try {
    ...
    // @ts-ignore
    const pdfjs: any = await import("pdfjs-dist/build/pdf.js");
    const path = await import("path");
    
    if (pdfjs.GlobalWorkerOptions) {
      pdfjs.GlobalWorkerOptions.workerSrc = path.join(process.cwd(), "node_modules", "pdfjs-dist", "build", "pdf.worker.js");
    }
