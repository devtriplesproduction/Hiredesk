  ...
  return (
    <div
      ...
      className={clsx(
        ...
        isFullscreen
          ? "fixed inset-3 z-50 bg-[var(--card-bg)]/98 backdrop-blur-2xl p-4 rounded-2xl border border-[var(--border-2)] shadow-[0_0_60px_rgba(0,0,0,0.8)]"
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5 px-3.5 py-2 rounded-xl border border-[var(--border-2)] bg-[var(--card-bg)] shadow-md select-none flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          {numPages > 1 && viewMode === "canvas" && (
            <div className="flex items-center gap-1 pl-3 border-l border-[var(--border-2)]">
              <button
                type="button"
                onClick={() => scrollToPage(currentPage - 1)}
                disabled={currentPage <= 1}
                className="w-6 h-6 rounded-md bg-[var(--glass-2)] hover:bg-[var(--glass-3)] disabled:opacity-30 disabled:hover:bg-transparent flex items-center justify-center text-[var(--text-2)] transition-colors"
                title="Previous Page"
              >
                <ChevronLeft className="w-3.5 h-3.5" />
              </button>
              <span className="text-xs font-mono font-medium text-[var(--text-2)] px-1">
        ...
        {viewMode === "canvas" && !loading && (
          <div className="flex items-center gap-1.5 flex-wrap">
            <div className="flex items-center gap-1 bg-[var(--glass-2)] border border-[var(--border)] rounded-lg p-0.5">
              <button
                type="button"
                onClick={handleZoomOut}
                className="w-6 h-6 rounded flex items-center justify-center text-[var(--text-2)] hover:text-[var(--text)] hover:bg-[var(--glass-3)] transition-colors"
                title="Zoom Out"
              >
              ...
              <button
                ...
                className="text-[15px] font-mono text-[var(--text-2)] hover:text-[var(--text)] px-2 py-0.5 rounded transition-colors"
            ...
            <button
              ...
              className={clsx(
                ...
                isFitWidth
                  ...
                  : "text-[var(--text-2)] hover:text-[var(--text)] bg-[var(--glass-2)] border border-[var(--border)] hover:border-[var(--border-2)]"
              )}
              title="Fit to Width"
            >
              Fit Width
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg text-xs font-medium text-[var(--text-2)] hover:text-[var(--text)] bg-[var(--glass-2)] border border-[var(--border)] hover:border-[var(--border-2)] transition-all duration-150"
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="inline-flex items-center p-0.5 rounded-lg bg-[var(--glass-2)] border border-[var(--border-2)]">
            <button
              type="button"
          ...
          <button
            ...
            className="w-7 h-7 rounded-lg bg-[var(--card-bg)] hover:bg-[var(--glass-3)] border border-[var(--border-2)] flex items-center justify-center text-[var(--text-2)] hover:text-[var(--text)] transition-colors"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 h-7 px-3 rounded-lg text-xs font-semibold bg-[var(--glass-3)] hover:bg-[var(--glass-3)] text-[var(--text)] border border-[var(--border-2)] transition-all active:scale-95"
      ...
      <div className="relative w-full flex-1 min-h-0 rounded-xl border border-[var(--border-2)] bg-[var(--card-bg)] overflow-hidden shadow-inner">
        {/* Loading Spinner */}
        {loading && (
          <div className="absolute inset-0 bg-[var(--card-bg)]/90 z-20 flex flex-col items-center justify-center gap-3 animate-fade-in">
            ...
            <div className="text-xs font-semibold text-[var(--text-2)] tracking-wider">
            ...
            {numPages > 0 ? (
                ...
                {Array.from({ length: numPages }, (_, i) => i + 1).map(
                  (pageNum) => (
                    ...
                    >
                      ...
                      <div className="relative shadow-[0_10px_35px_rgba(0,0,0,0.6)] rounded-sm bg-white overflow-hidden border border-[var(--border-2)]">
                        <canvas
                          ref={(el) => {
                      ...
                      {numPages > 1 && (
                        <div className="mt-2 text-[15px] font-mono text-[var(--text-3)] select-none">
              ...
              !loading && (
                <div className="flex flex-col items-center justify-center h-full text-center p-6 gap-3">
                  ...
                  <div className="text-xs text-[var(--text-2)] max-w-sm">
