        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between p-6 sm:p-8 pb-5 gap-5" style={{ borderBottom: "1px solid var(--border)", background: "linear-gradient(to bottom, rgba(255,255,255,0.03), transparent)" }}>
          <div className="flex items-center gap-5 flex-1">
            ...
            <div className={clsx(
              ...
              isLowConfidence 
                ...
                : "border-[var(--border-2)] bg-white/5 text-text"
            )}>
            ...
            <div className="flex-1 min-w-0">
              {isEditing ? (
                <input
                  ...
                  className="w-full max-w-sm bg-black/60 border border-border rounded-xl px-3 py-1.5 text-base font-bold text-text outline-none focus:border-white/30"
              ...
              <div className="text-xs sm:text-sm text-[var(--text-3)] font-medium mt-1 flex gap-2 items-center">
                {isEditing ? (
                  <select 
                    ...
                    className="bg-black/60 border border-border rounded-lg px-2 py-1 outline-none focus:border-white/30 text-text"
                  >
                    {roles.map(r => (
          ...
          <div className="flex items-center gap-2 flex-wrap lg:flex-nowrap overflow-x-auto no-scrollbar self-start lg:self-center flex-shrink-0">
            ...
            {isEditing ? (
              <Btn
                onClick={handleSave}
                className="h-[38px] text-xs font-semibold px-4 rounded-[10px] transition-all text-bg2 bg-white hover:bg-zinc-200 active:scale-95 shadow-lg inline-flex items-center gap-1.5 flex-shrink-0"
              >
              ...
              <Btn
                ...
                className="h-[38px] text-xs font-semibold px-3.5 rounded-[10px] transition-all text-text hover:text-[var(--text)] bg-[var(--card-bg)] hover:bg-[var(--table-row-hover)] border border-[var(--border-2)] hover:border-zinc-500 active:scale-95 inline-flex items-center gap-1.5 flex-shrink-0"
              >
            ...
            <button
              type="button"
              onClick={onClose}
              className="h-[38px] px-3 rounded-[10px] flex items-center justify-center gap-1.5 text-xs font-semibold text-text-2 hover:text-[var(--text)] bg-[var(--card-bg)] hover:bg-[var(--table-row-hover)] border border-[var(--border-2)] hover:border-zinc-400 active:scale-95 transition-all cursor-pointer flex-shrink-0 shadow-sm"
              title="Close (Cancel)"
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 pt-6 custom-scrollbar">
          {activeTab === "profile" && (
            <div className="flex flex-col gap-6 w-full">
              ...
              <div className="flex items-center justify-between gap-3 flex-wrap border-b border-white/[0.06] pb-3.5">
                <div className="flex items-center gap-1.5 p-1 bg-[var(--card-bg)] border border-white/[0.08] rounded-xl overflow-x-auto no-scrollbar shadow-sm">
                  {([
                    ...
                    return (
                      <button
                        ...
                        className={clsx(
                          ...
                          isCurrent
                            ? "bg-white/[0.08] text-text border border-white/[0.12] shadow-sm"
                            : "text-text-2 hover:text-text hover:bg-white/[0.03] border border-transparent"
                        )}
                      >
                        ...
                        {tab.count !== undefined && (
                          <span className={clsx(
                            ...
                            isCurrent ? "bg-white/10 text-text" : "bg-white/5 text-text-3"
                          )}>
                            {tab.count}
                          </span>
                        )}
              ...
              {(profileSubTab === "overview" || profileSubTab === "all") && (
                <div className="rounded-2xl border border-white/[0.09] bg-gradient-to-b from-[#18181b]/95 to-[#111114]/95 p-4 sm:p-5 flex flex-col gap-4 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
                {/* Header Strip */}
                <div className="flex items-center justify-between border-b border-white/[0.08] pb-3 flex-wrap gap-2.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  {/* 1. Email */}
                  <div className="flex flex-col justify-between p-3.5 rounded-xl bg-white/[0.035] hover:bg-white/[0.06] border border-white/[0.07] hover:border-white/[0.16] transition-all min-h-[76px] group shadow-sm">
                      ...
                      {!isEditing && c.email && (
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="p-1 rounded text-text-2 hover:text-text hover:bg-white/[0.08] transition-colors cursor-pointer"
                            title="Copy email"
                          >
                            {copiedField === "email" ? (
                    ...
                    {isEditing ? (
                      <input
                        ...
                        className="w-full bg-black/60 border border-border-2 rounded-lg px-2.5 py-1 text-sm text-text outline-none focus:border-purple-500 mt-1.5"
                        placeholder="email@example.com"
                      />
                    ) : (
                      <div className="text-[14px] font-semibold text-zinc-100 select-all break-all leading-snug mt-1.5" title={c.email || undefined}>
                  ...
                  <div className="flex flex-col justify-between p-3.5 rounded-xl bg-white/[0.035] hover:bg-white/[0.06] border border-white/[0.07] hover:border-white/[0.16] transition-all min-h-[76px] group shadow-sm">
                    ...
                    {isEditing ? (
                      ...
                      <div className="text-[14px] font-semibold text-zinc-100 select-all leading-snug mt-1.5 tracking-wide" title={c.phone || undefined}>
                  ...
                  {/* 3. Location */}
                  <div className="flex flex-col justify-between p-3.5 rounded-xl bg-white/[0.035] hover:bg-white/[0.06] border border-white/[0.07] hover:border-white/[0.16] transition-all min-h-[76px] shadow-sm">
                    ...
                    {isEditing ? (
                      ...
                      <div className="text-[14px] font-semibold text-zinc-100 leading-snug mt-1.5">
                  ...
                  <div className="flex flex-col justify-between p-3.5 rounded-xl bg-white/[0.035] hover:bg-white/[0.06] border border-white/[0.07] hover:border-white/[0.16] transition-all min-h-[76px] shadow-sm">
                    ...
                    {isEditing ? (
                      <select
                        ...
                        className="w-full bg-black/60 border border-border-2 text-text rounded-lg px-2.5 py-1 text-xs outline-none focus:border-purple-500 mt-1.5"
                      >
                  ...
                  <div className="flex flex-col justify-between p-3.5 rounded-xl bg-white/[0.035] hover:bg-white/[0.06] border border-white/[0.07] hover:border-white/[0.16] transition-all min-h-[76px] shadow-sm">
                    ...
                    {isEditing ? (
                      ...
                      <div className="text-[13px] sm:text-[14px] font-semibold text-zinc-100 leading-snug line-clamp-2 break-words mt-1.5" title={c.education || undefined}>
              ...
              {(profileSubTab === "skills" || profileSubTab === "all") && (
                <div className="rounded-2xl border border-white/[0.08] bg-[var(--card-bg)] p-5 sm:p-6 flex flex-col gap-3 shadow-[0_4px_24px_rgba(0,0,0,0.35)]">
                <div className="flex items-center justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                  {cleanSkills.length > 0 ? (
                    cleanSkills.map(s => (
                      <span
                        key={s}
                        className="px-3 py-1 rounded-lg text-xs font-medium bg-white/[0.04] text-text border border-white/[0.08] hover:border-cyan-500/40 hover:text-cyan-300 transition-colors"
                      >
                        {s}
                      </span>
                    ))
              ...
              {(profileSubTab === "stage" || profileSubTab === "all") && (
                <div className="rounded-2xl border border-white/[0.08] bg-[var(--card-bg)] p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-[0_4px_24px_rgba(0,0,0,0.35)]">
              ...
              {(profileSubTab === "activity" || profileSubTab === "all") && (() => {
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2.5 min-w-0">
                      <div className="text-sm font-bold text-text tracking-tight flex items-center gap-2">
                        ...
                        <span className="text-[16px] font-mono px-2 py-0.5 rounded-full bg-white/[0.05] text-[var(--text)] border border-white/[0.08]">
                  ...
                  <div className="flex items-center gap-2.5 flex-shrink-0">
                          ...
                          <button
                            ...
                            className={clsx(
                              ...
                              timelineTab === tabKey
                                ...
                                : "text-[var(--text)] hover:text-[var(--text)] hover:bg-white/[0.04] border border-transparent"
                            )}
                          >
                    ...
                    <button
                      type="button"
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-text-2 hover:text-[var(--text)] bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] transition-all cursor-pointer"
                    >
                        ...
                        <div className={clsx(
                          ...
                          <div className="flex flex-col gap-2.5">
                            <textarea
                              ...
                              className="w-full rounded-xl text-xs sm:text-sm p-4 resize-none outline-none transition-all duration-200 bg-[var(--card-bg)] border border-[var(--border-2)] text-text focus:border-purple-500/60 focus:shadow-[0_0_15px_rgba(167,139,250,0.12)] custom-scrollbar placeholder:text-zinc-600 leading-relaxed"
                            />
              ...
              {c.extractionMetadata && (profileSubTab === "overview" || profileSubTab === "all") && (
                <details className="group rounded-xl border border-border bg-[var(--card-bg)]/40 p-4 transition-all mt-1">
                  ...
                  <div className="mt-4 flex flex-col gap-4 text-xs leading-relaxed border-t border-border pt-4">
                    <div className="flex justify-between items-center bg-black/20 p-2.5 rounded-lg border border-border">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-2 max-h-[180px] overflow-y-auto pr-1">
                        {c.extractionMetadata.sourceRankings && c.extractionMetadata.sourceRankings.length > 0 ? (
                          ...
                          <div className="text-[var(--text-3)] italic text-center py-2 bg-black/20 rounded-xl border border-dashed border-border">No candidates extracted</div>
                        )}
                      </div>
                    </div>
                            ...
                            return (
                              <div key={idx} className={clsx(
                                ...
                                isHeading 
                                  ...
                                  : "bg-black/30 border-border text-text-2 font-mono"
                              )} title={tooltip}>
                  ...
                  <div className="flex flex-col gap-2 w-full flex-1 min-h-0 h-[calc(98vh-220px)] min-h-[600px]">
                    <div className="flex justify-end">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-white/5 hover:bg-glass-2 text-text-2 hover:text-[var(--text)] border border-border transition-colors"
                      >
                        <Copy className="w-3.5 h-3.5" />
                        <span>Copy Text</span>
                      </button>
          ...
          {activeTab === "pipeline" && (
            <div className="flex flex-col gap-6 animate-fade-in w-full pt-1">
              ...
              <div className="rounded-2xl border border-white/[0.08] bg-[var(--card-bg)] p-4 sm:p-5 shadow-[0_4px_24px_rgba(0,0,0,0.35)]">
              ...
              {["new", "review", "shortlisted", "interview_1", "interview_2", "approved", "rejected", "offer", "offer_sent", "offer_accepted", "offer_rejected", "hired"].includes(c.status) && (
                <div className="rounded-2xl border border-white/[0.08] bg-[var(--card-bg)] p-5 sm:p-6 shadow-[0_4px_24px_rgba(0,0,0,0.35)] flex flex-col gap-4">
                  {/* Section Header */}
                  <div className="flex items-center justify-between border-b border-white/[0.06] pb-3.5 flex-wrap gap-2">
                    ...
                    <span className="text-[15px] font-mono px-2.5 py-0.5 rounded-full bg-white/[0.04] border border-white/[0.08] text-text-2">
                  ...
                  >
                    <div>
                      ...
                      {r1 && (
                        <div className="flex flex-col gap-3">
                          <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/[0.03] border border-white/[0.06] text-xs text-text-2 flex-wrap">
                          ...
                          {isR1Scheduled && (
                            <div className="flex flex-col gap-2.5 mt-0.5">
                              <textarea
                                ...
                                className="w-full bg-[var(--card-bg)] text-text text-xs border border-white/[0.10] rounded-xl p-3 outline-none h-20 focus:border-purple-400/60 focus:ring-1 focus:ring-purple-400/30 transition-all placeholder:text-zinc-600"
                              />
                          ...
                          {isR1Passed && (
                            <div className="flex flex-col gap-2.5">
                              ...
                              {r1.notes && (
                                <div className="text-xs text-text-2 bg-[var(--card-bg)] p-3 rounded-xl border border-white/[0.06]">
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <div className="flex items-center gap-2.5">
                          <div className={clsx(
                            "w-8 h-8 rounded-xl flex items-center justify-center transition-all",
                            isR2Locked ? "bg-white/[0.03] border border-white/[0.08] text-text-3" :
                          ...
                          <div>
                            <div className={clsx("font-bold text-xs sm:text-sm", isR2Locked ? "text-text-3" : "text-zinc-100")}>
                              Round 2
                            </div>
                        ...
                        {/* Status Badges */}
                        {isR2Locked && (
                          <span className="text-[10.5px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full inline-flex items-center gap-1 bg-white/[0.04] border border-white/[0.10] text-text-2">
                      ...
                      {isR2Locked && (
                        <div className="flex flex-col items-center justify-center text-center py-6 gap-2 my-auto">
                          <div className={clsx(
                            ...
                            isR1Rejected ? "bg-red-500/10 border border-red-500/20 text-red-400" : "bg-white/[0.03] border border-white/[0.08] text-text-3"
                          )}>
                            <Lock className="w-4 h-4" />
                          </div>
            ...
            {["approved", "offer", "offer_sent", "offer_accepted", "offer_rejected", "onboarding_requested", "onboarding_review", "onboarding_verified", "onboarding_rejected", "hired"].includes(c.status) ? (
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    {candidateOffer ? (
                      ...
                      <span className="text-[10.5px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-white/[0.04] border border-white/[0.10] text-text-2">
                        Ready to Draft
                      </span>
                    )}
                  </div>

                  <div className="p-4 rounded-xl flex flex-col gap-3.5 bg-[var(--card-bg)] border border-white/[0.06]">
                    {!candidateOffer ? (
                      c.status === "approved" ? (
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        {candidateOffer.status === "draft" && c.status === "offer" && (
                          <div className="flex flex-col sm:flex-row gap-2 mt-1">
                            <button
                              type="button"
                              className="inline-flex items-center justify-center gap-2 h-10 px-4 rounded-xl text-xs font-semibold text-text bg-white/[0.05] hover:bg-white/[0.09] border border-white/[0.12] hover:border-white/[0.22] active:scale-[0.98] transition-all cursor-pointer flex-1"
                              onClick={() => {
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-3">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-xl bg-white/[0.03] border border-white/[0.08] flex items-center justify-center text-text-3">
                        <Briefcase className="w-4 h-4" />
                      </div>
                      <div>
                    ...
                    <span className="text-[10.5px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-white/[0.04] border border-white/[0.10] text-text-3">
                      Pending Interviews
                    </span>
                  </div>
                  <div className="p-6 rounded-xl flex flex-col items-center justify-center text-center gap-2 bg-[var(--card-bg)] border border-dashed border-white/[0.10]">
                    <div className="w-9 h-9 rounded-xl bg-white/[0.03] border border-white/[0.08] flex items-center justify-center text-text-3">
                      <Briefcase className="w-4 h-4" />
                    </div>
              ...
              <div className="flex flex-col gap-3.5">
                ...
                <div className="flex items-center justify-between gap-3 flex-wrap">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {candidateDocs.length > 0 && (
                          <span className="text-[16px] font-mono font-bold px-2 py-0.5 rounded-full bg-white/[0.05] border border-white/[0.08] text-text-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold text-text-2 hover:text-[var(--text)] bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.10] hover:border-white/[0.20] active:scale-95 transition-all cursor-pointer"
                  >
                    {copiedUploadLink ? (
                  ...
                  <div className="flex flex-col gap-2">
                    {candidateDocs.map(doc => {
                      ...
                      return (
                        <div
                          key={doc.id}
                          className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 sm:px-4 sm:py-3 rounded-xl transition-all duration-150 group bg-[var(--card-bg)] hover:bg-[var(--card-bg)] border border-white/[0.06]"
                        >
                          {/* File Details */}
                          <div className="flex items-center gap-3 min-w-0 flex-1">
                            <div className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] flex items-center justify-center flex-shrink-0 text-indigo-400 group-hover:border-border-2 transition-all">
                              <FileText className="w-4 h-4" />
                            </div>
                            ...
                            <div className="flex flex-col min-w-0 flex-1 gap-1">
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <span className="text-[16px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-md bg-white/[0.05] border border-white/[0.08] text-text-2">
                                  {doc.type || "Document"}
                                </span>
                              </div>
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0 self-end sm:self-center">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-text-2 hover:text-[var(--text)] bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.10] hover:border-white/[0.20] active:scale-95 transition-all cursor-pointer"
                ...
                <div className="p-4 rounded-xl border border-emerald-500/30 bg-emerald-500/[0.08] mt-2">
                  ...
                  <div className="mt-3 pt-3 border-t border-emerald-500/20">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <button
                        type="button"
                        className="text-[16px] font-semibold px-2.5 py-1 rounded-md bg-white/[0.08] hover:bg-white/[0.14] text-text border border-white/[0.10] transition-all cursor-pointer"
                    ...
                    {employeeResignation ? (
                      <div className="bg-red-500/10 border border-red-500/20 p-2.5 rounded-lg">
                        ...
                        <div className="mt-3 flex flex-col gap-2">
                          <button
                            type="button"
                            className="w-full text-xs py-2 rounded-lg bg-white/[0.06] hover:bg-white/[0.12] text-text border border-white/[0.10] transition-all cursor-pointer font-semibold"
                            onClick={() => {
                        ...
                        {showResignationForm && (
                          <div className="mt-2.5 flex flex-col gap-2.5 p-3 rounded-xl bg-glass-2 border border-red-500/20">
                            <textarea
                              ...
                              className="w-full bg-[var(--card-bg)] border border-white/[0.10] rounded-lg p-2.5 text-xs text-text outline-none focus:border-red-400/50"
                            />
